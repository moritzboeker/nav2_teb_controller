...
VisibilityGraphSearch::VisibilityGraphSearch(double inflation_radius,
                                             double robot_radius)
...
bool VisibilityGraphSearch::search(
  const PoseSE2& /*start*/ ,
  const PoseSE2& /*goal*/,
  ...
  int k) const
{
  ...
  (void)graph; (void)start_id; (void)goal_id; (void)k;
  return {};
}
  ...
  double h_sig_tolerance) const
{
  ...
  (void)results; (void)h_sig_tolerance;
}
