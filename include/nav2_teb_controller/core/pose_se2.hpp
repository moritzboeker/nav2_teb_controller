...
public:
  ...
  void plus(const double* pose_as_array) // needed for g2o vertex_pose, expects array[3]: {dx, dy, dtheta}
  {
...
inline std::vector<nav2_teb_controller::PoseSE2> posesFromPath(const nav_msgs::msg::Path& path, size_t max_poses = 20)
{
